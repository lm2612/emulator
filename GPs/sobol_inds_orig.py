...
if __name__ == '__main__':
    ...
    for n in range(10):
        print(end)
        subsetX = Xparam[start:end]
        subsetY = ypred[start:end]
        subsetSD = sd[start:end]
    
        save_file = '../../emulator_outputs/indepdims_GP_sobol_2xCO2bound_{}.file'.format(n)
        save_objs = {'X':subsetX, 'ypred':subsetY, 'sd':subsetSD, 'problem':problem}
