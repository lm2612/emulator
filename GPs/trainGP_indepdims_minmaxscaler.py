...
def predict_function(i, y, ypred, sd, X, Xtest):
    ...
    #kern1.variance = 0.02669
    kern1.variance = 6.67e-6

    #kern1.lengthscale = [0.5514, 223.2, 2.294, 2.333, 478.6, 144.4, 261.2, 488.1, 446.7]
    kern1.lengthscale = [0.89, 0.83, 0.94, 1.11, 0.37, 1., 0.96, 0.93, 0.75]

    kern2 = GPy.kern.Linear(p,ARD=True)
    #kern2.variances = [0.638, 0.0155, 0.0173,  0.0001, 0.0001, 0.0076, 0.0245, 0.0001, 0.0001]
...
if __name__ == '__main__':
    ...
    save_file = '../../emulator_outputs/indepdims_GP_minmaxscaler.file'
